...
[stego, distortion] = HUGO_like(cover, payload);
...
%   -----------------------------------------------------------------------
%   config.gamma		single	    1		   distortion parameter gamma
%   config.sigma		single		1		   distortion parameter sigma
...
%   Example:
%
%   config.gamma = single(2);
%   config.sigma = single(3);
%   config.STC_h = uint32(10);
%   config.seed  = int32(123);
%  
%   [stego, distortion] = HUGO_like(cover, payload, config);
