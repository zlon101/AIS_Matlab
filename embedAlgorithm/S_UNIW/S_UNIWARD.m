...
% -------------------------------------------------------------------------
% [stego, distortion] = S_UNIWARD(cover, payload) embeds a payload using simulated optimal
% coding for minimizing 'S-UNIWARD' distortion - it uses default settings
%
% [stego, distortion] = S_UNIWARD(cover, payload, config) - same as above but using
